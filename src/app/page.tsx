...
export default function Home() {
  ...
  return (
    <div className="fadeIn">
      ...
      <div className="container mt-8 xl:mt-16 mb-4 xl:mb-8 mx-auto px-8 xl:px-24 fadeIn1">
        <div className="flex flex-col items-center mb-16">
          <p className="text-xl xl:text-3xl mb-16 !text-stone-300">
          ...
          <div className="text-2xl xl:text-3xl font-semibold mb-4 !text-stone-300">Listen on</div>
