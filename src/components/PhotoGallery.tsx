...
export function PhotoGallery() {
  ...
  const photos: Photo[] = [
    { src: "/photo/1.jpg", width: 7360, height: 4898, alt: 'Leyla Romanova' },
    { src: "/photo/2.jpg", width: 2683, height: BASE_HEIGHT , alt: 'Leyla Romanova' },
    { src: "/photo/3.jpg", width: 2683, height: BASE_HEIGHT , alt: 'Leyla Romanova' },
    { src: "/photo/4.jpg", width: 2683, height: BASE_HEIGHT , alt: 'Leyla Romanova' },
    { src: "/photo/5.jpg", width: 3269, height: 4912 , alt: 'Leyla Romanova' },
    ...
    { src: "/photo/28.jpg", width: 3423, height: 4792 , alt: 'Leyla Romanova' },
    { src: "/photo/29.jpg", width: 5464, height: 7650 , alt: 'Leyla Romanova' },
    { src: "/photo/30.jpg", width: 5199, height: 7350 , alt: 'Leyla Romanova' },
    { src: "/photo/31.jpg", width: 5464, height: 7650 , alt: 'Leyla Romanova' },
    { src: "/photo/32.jpg", width: 3276, height: 4912 , alt: 'Leyla Romanova' },
  ];
